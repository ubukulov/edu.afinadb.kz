<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Дмитрий Телюк</a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                {{--<li class="nav-item">
                    <a href="{{ route('lessons.index') }}" class="nav-link {{ (request()->segment(2) == 'lessons') ? 'active' : '' }}">
                ...
                {{--<li class="nav-item">
                    <a href="{{ route('tests.index') }}" class="nav-link {{ (request()->segment(2) == 'tests') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="https://admin_ltelte.io/docs/3.0" class="nav-link">
