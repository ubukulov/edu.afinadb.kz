...
<head>
    ...
    <title>Обучающий портал | Панель управление</title>
    <!-- Font Awesome Icons -->
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('home') }}" target="_blank" class="nav-link">Перейти на сайт</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="/admin_lte/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="/admin_lte/plugins/raphael/raphael.min.js"></script>
<script src="/admin_lte/plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="/admin_lte/plugins/jquery-mapael/maps/usa_states.min.js"></script>
<!-- ChartJS -->
<script src="/admin_lte/plugins/chart.js/Chart.min.js"></script>

<!-- PAGE SCRIPTS -->
<script src="/admin_lte/dist/js/pages/dashboard2.js"></script>
</body>
</html>
